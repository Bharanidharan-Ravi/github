...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@tiptap/starter-kit/package.json": resolvePackageJson(
        "@tiptap/starter-kit",
      ),
      "@tiptap/extension-image/package.json": resolvePackageJson(
        "@tiptap/extension-image",
      ),
      "@tiptap/extension-link/package.json": resolvePackageJson(
        "@tiptap/extension-link",
      ),
      "@tiptap/extension-mention/package.json": resolvePackageJson(
        "@tiptap/extension-mention",
      ),
      "@tiptap/extension-placeholder/package.json": resolvePackageJson(
        "@tiptap/extension-placeholder",
      ),
      "@tiptap/extension-table/package.json": resolvePackageJson(
        "@tiptap/extension-table",
      ),
      "@tiptap/extension-table-cell/package.json": resolvePackageJson(
        "@tiptap/extension-table-cell",
      ),
      "@tiptap/extension-table-header/package.json": resolvePackageJson(
        "@tiptap/extension-table-header",
      ),
      "@tiptap/extension-table-row/package.json": resolvePackageJson(
        "@tiptap/extension-table-row",
      ),
      "@tiptap/extension-underline/package.json": resolvePackageJson(
        "@tiptap/extension-underline",
      ),
      ...
      "prosemirror-transform/package.json": resolvePackageJson(
